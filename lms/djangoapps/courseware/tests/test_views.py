...
from xmodule.modulestore.tests.django_utils import (TEST_DATA_MOCK_MODULESTORE, TEST_DATA_MIXED_TOY_MODULESTORE)
...
class TestIndexView(ModuleStoreTestCase):
    ...
    def test_student_state(self, default_store):
        ...
        with modulestore().default_store(default_store):
            ...
            section = ItemFactory(parent=chapter, category='view_checker', display_name="Sequence Checker")
            vertical = ItemFactory(parent=section, category='view_checker', display_name="Vertical Checker")
            block = ItemFactory(parent=vertical, category='view_checker', display_name="Block Checker")
